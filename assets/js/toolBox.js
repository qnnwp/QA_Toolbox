...
(function () {
    ...
    /* Tampermonkey function to get resource files from the meta tag located in the Chrome extension. */
    ...
    var checkLinks = {
        ...
        nextgenTestLinks: function () {
            var $cardDeck,
                /*$cardImageContainer, $cardLinkContainer, $cardLinks, $cardSEOContainer,
                                   $copyTextLinks,*/
                $currentCard, /*$currentLink, $image, $imagelink,*/

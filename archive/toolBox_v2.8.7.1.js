...
// @version 2.8.7.1
// @author Eric Tanaka
// @description Next Gen QA Tool Bar
...
/*global jQuery, unsafeWindow, GM_getValue, GM_setValue, GM_setClipboard, GM_openInTab, window, GM_info, document */
...
if (!em && sv && !pw) {
    ...
    // ---------------------------------------- highlight possible autofill text ----------------------------------------

    //    var $haf_butt = jQuery('<button>').attr({
    //        class: 'myEDOBut',
    //        id: 'highlightAutofilles',
    //        title: 'Highlight Autofills'
    //    }).text('highlight autofills');
    //
    //    $haf_butt.click(function () {
    //
    //        var a = "?disableAutofill=true",
    //            b = cm.getUrl(),
    //            $search = {
    //                c: cm.getCity(),
    //                d: cm.getAddressLine1(),
    //                e: cm.getAddressLine2(),
    //                g: cm.getCollisionPhone(),
    //                h: cm.getFleetPhone(),
    //                i: cm.getNewPhone(),
    //                j: cm.getPartsPhone(),
    //                k: cm.getPrimaryPhone(),
    //                l: cm.getServicePhone(),
    //                m: cm.getUsedPhone(),
    //                n: cm.getFinancePhone(),
    //                o: cm.getPreferredState(),
    //                p: cm.getZip(),
    //            },
    //            key,
    //            text = jQuery('.page *:not(:has(*)):visible').text();
    //
    //        console.log(text);
    //
    //        if (b.indexOf(a)) {
    ...
    //
    //                //jQuery('.page *:not(:has(*)):visible').replaceWith(highlight(value));
    //            }
    //        }
    //
    //    });
    ...
    $404checker_butt.on('click', function () {
        ...
        jQuery("#myToolbox").append($404legend);
        ...
        jQuery('#404checker').after($container);
        // show thinking icon
